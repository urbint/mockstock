...
import (
	...
	"github.com/urbint/mockstock/generator"
)
...
func main() {
	...
	var osp generator.OutputStreamProvider
	if config.fPrint {
		osp = &generator.StdoutStreamProvider{}
	} else {
		osp = &generator.FileOutputStreamProvider{
	...
	visitor := &generator.GeneratorVisitor{
		InPackage: config.fIP,
		Note:      config.fNote,
		Osp:       osp,
	}
